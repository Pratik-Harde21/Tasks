...
export default function InstructDesign(){
    const [isClickedInstruDesign, setIsClickedInstruDesign] = useState(false)
    function toggle(){
        setIsClickedInstruDesign(prevVal => !prevVal)
    }
    return(
        <>
            <div className="card">
                <div className="pre-requisites" onClick={toggle}>
                    ...
                    {isClickedInstruDesign ? <span className="material-symbols-outlined">expand_less</span> : <span className="material-symbols-outlined">expand_more</span>}
                </div>
                {isClickedInstruDesign && <div className="dropable">
