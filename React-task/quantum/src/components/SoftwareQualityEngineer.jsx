...
export default function SoftwareQaEngineer(){
    const [isClickedSoftQaEng, setIsClickedSoftQaEng] = useState(false)
    function toggle(){
        setIsClickedSoftQaEng(prevVal => !prevVal)
    }
    return(
        <>
            <div className="card">
                <div className="pre-requisites" onClick={toggle}>
                    ...
                    {isClickedSoftQaEng ? <span className="material-symbols-outlined">expand_less</span> : <span className="material-symbols-outlined">expand_more</span>}
                </div>
                {isClickedSoftQaEng && <div className="dropable">
